...
public class ReflectUtil {
     ...
     * @throws Exception
     */
    public static Map<String, Object> reflectMap(Object e) throws IllegalAccessException {
        Class<?> cls = e.getClass();
        Field[] fields = cls.getDeclaredFields();
        Map<String, Object> res = new HashMap<>(fields.length * 4 / 3 + 1);
        for (Field f : fields) {
            f.setAccessible(true);
            res.put(f.getName(), f.get(e));
        }
        return res;
    }
    ...
    /**
     * 查找指定类中的所有字段
     * 包括非 public 字段, 也包括父类和Object类的字段
     * 字段不存在则返回<code>null</code>
     *
